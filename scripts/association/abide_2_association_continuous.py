...
def associate_continuous(contrast):
    # Hardcoded variables
    ...
    out_p = out_d / f'abide2_continuous_assoc_mist_{scale}_with_{contrast}.tsv'
    if not out_d.is_dir():
        out_d.mkdir()
...
if __name__ == "__main__":
    ...
    parser.add_argument("contrast", type=str,
                        help="specify the covariate you want to contrast")
    args = parser.parse_args()
    associate_continuous(args.contrast)
